...
import viewTubeMobile from "../assets/yt-logo-mobile.png";
    ...
    <div className="flex flex-row h-14 px-4 md:px-5 justify-between items-center sticky top-0 z-20 bg-white dark:bg-black shadow-md">
      ...
      <div className="flex h-5 items-center">
        ...
        <Link to="/" className="flex h-5 items-center">
          <img src={viewTube} alt="viewTube" className="h-40 hidden md:block" />
          <img
            src={viewTubeMobile}
            alt="viewTube"
      ...
      <div className="flex items-center">
        ...
        <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
          <Link to={"https://github.com/ujjwalkur"} target="block">
            <img src={profileImg} alt="ujjwal kumar" />
          </Link>
        </div>
      </div>
    </div>
